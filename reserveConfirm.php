    ...
    <!-- 各ページスクリプト挿入場所 -->    
          <section>
            <form action="./reserveInsert.php" method="post">
              ...
              <h3>予約情報</h3>
              <table class="input">
                <tr><th>お部屋名称</th><td><?= $roomName ?></td></tr>
                <tr><th>宿泊日</th><td><?php echo date('Y年n月j日', strtotime($reserveDay)); ?></td></tr>
              </table>
              <br>
              <h3>代表者情報</h3>
              <table class="input">
                <tr><th>代表者氏名</th><td><?= $dname ?></td></tr>
                <tr><th>連絡先電話番号</th><td><?= $dtelno ?></td></tr>
                <tr><th>メールアドレス</th><td><?= $dmail ?></td></tr>
              </table>
              <br>
              <h3>予約詳細情報</h3>
              <table class="input">
                <tr><th>宿泊人数</th><td><?= $reserveNumber ?></td></tr>
                <tr><th>チェックイン予定時間</th><td><?= $checkin ?></td></tr>
                <tr><th>連絡事項</th><td><?= $message ?></td></tr>
              </table>
              <br>
